...
$$|\Fadn| = \prod_{a \in N} n_a \quad\geq 2^{|N|}$$
...
\bigskip
The structure of the ADN can give some results on its behaviour.

\quad e.g.: \tcite{\citerichardcomet}

But methods related to reachability rely on the State Graph

\quad e.g.: \todo{Logiques CTL ? SMBionet ?}
