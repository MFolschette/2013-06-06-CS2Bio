...
\tikzstyle{prio}=[draw,very thick,-stealth]%[double]
...
\tikzstyle{Aproc}=[draw]
\tikzstyle{Aobj}=[]
\colorlet{colorhl}{notsodarkred}
\colorlet{colorhlbg}{lightred}
\tikzstyle{Ahl}=[very thick,fill=colorhlbg,draw=colorhl,text=colorhl]
