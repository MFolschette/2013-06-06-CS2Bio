...
\section{Asynchronous Discrete Networks (ADN)}
\input{parts/adn_def.tex}

\section{The Process Hitting framework (PH)}
\input{parts/ph_def.tex}
\input{parts/ph_static.tex}
\input{parts/ph_static_ex.tex}
\input{parts/ph_ccl.tex}

\section{Adding priorities to the Process Hitting}
\input{parts/prio_def.tex}
...
\section[Annex: Graphs of local causality]{Examples of graphs of local causality}
